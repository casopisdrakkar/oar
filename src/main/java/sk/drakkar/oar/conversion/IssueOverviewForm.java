...
public class IssueOverviewForm extends JFrame {
	...
	private void addEditorial(List<Summary> summaries) {
		...
		summary.setTitle("�vodn�k");
		summary.setAuthors("redakce");
		summary.setTags("�vodn�k");
		summary.setShortSummary("�vodn� slovo");
	...
	protected void handleDroppedFile(File droppedFile) {
		try {
			...
			JOptionPane.showConfirmDialog(this, "Zl� n�zov s�boru s PDF", "Chyba", JOptionPane.ERROR_MESSAGE);
		}
	}
